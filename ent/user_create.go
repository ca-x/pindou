...
func (_c *UserCreate) SetSessionExpires(v time.Time) *UserCreate {
	_c.mutation.SetSessionExpires(v)
	return _c
}

// SetNillableSessionExpires sets the "session_expires" field if the given value is not nil.
func (_c *UserCreate) SetNillableSessionExpires(v *time.Time) *UserCreate {
	if v != nil {
		_c.SetSessionExpires(*v)
	}
	return _c
}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.SessionExpires(); ok {
