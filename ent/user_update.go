...
func (_u *UserUpdate) ClearSessionToken() *UserUpdate {
	_u.mutation.ClearSessionToken()
	return _u
}

// SetSessionExpires sets the "session_expires" field.
func (_u *UserUpdate) SetSessionExpires(v time.Time) *UserUpdate {
	_u.mutation.SetSessionExpires(v)
	return _u
}

// SetNillableSessionExpires sets the "session_expires" field if the given value is not nil.
func (_u *UserUpdate) SetNillableSessionExpires(v *time.Time) *UserUpdate {
	if v != nil {
		_u.SetSessionExpires(*v)
	}
	return _u
}

// ClearSessionExpires clears the value of the "session_expires" field.
func (_u *UserUpdate) ClearSessionExpires() *UserUpdate {
	_u.mutation.ClearSessionExpires()
	return _u
}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.SessionExpires(); ok {
		_spec.SetField(user.FieldSessionExpires, field.TypeTime, value)
	}
	if _u.mutation.SessionExpiresCleared() {
...
// ClearSessionToken clears the value of the "session_token" field.
func (_u *UserUpdateOne) ClearSessionToken() *UserUpdateOne {
	_u.mutation.ClearSessionToken()
	return _u
}

// SetSessionExpires sets the "session_expires" field.
func (_u *UserUpdateOne) SetSessionExpires(v time.Time) *UserUpdateOne {
	_u.mutation.SetSessionExpires(v)
	return _u
}

// SetNillableSessionExpires sets the "session_expires" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableSessionExpires(v *time.Time) *UserUpdateOne {
	if v != nil {
		_u.SetSessionExpires(*v)
	}
	return _u
...
// ClearSessionExpires clears the value of the "session_expires" field.
func (_u *UserUpdateOne) ClearSessionExpires() *UserUpdateOne {
	_u.mutation.ClearSessionExpires()
	return _u
}
